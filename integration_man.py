...
try:
	...
	try:
		...
		a[0].send_keys('sm.galleria@soultree.in')
		a[1].send_keys('8368740516')
...
try:
	...
	for js in sheetinjson:
		...
		if 1 :
			...
			outlet = str(js[outletindex].strip())
			...
			if outlet == 'DLF Promenade mall':
				store_code = 'DPS'

			elif outlet == 'Galleria Market':
				store_code = 'GGS'
			
			elif outlet == 'Lulu mall, Bangalore':
				store_code = 'BLS'
			
			elif outlet == 'Khan Market':
				store_code = 'DKS'
	...
	# emailbody['From'] = "soultree daily orders sync report<neeraj@mobiquest.com>"
	# emailbody['To'] = "neeraj@mobiquest.com"
	...
	# #toaddr=["neeraj@mobiquest.com"]
	# toaddr=["ayushi@mobiquest.com","anoop@mobiquest.com"]
					
	# #server.login("anoop@mobiquest.com", "mobianoop@1972")
	# #server.login("campaignroi@mobiquest.com", "c@mp@ign@2018")
	# server.login("neeraj@mobiquest.com", "qawsed@321")

	# server.sendmail("soultree daily orders sync report<neeraj@mobiquest.com>", toaddr , emailbody.as_string())
